...
public class ProductDataLoader implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		productRepository.save(new Product(1, "Mother & Babycat Comida Seca", "Royal Canin", "fk2", 
		...
		productRepository.save(new Product(2, "Mother & Babycat Comida Seca", "Royal Canin", "fk2", 
		...
		productRepository.save(new Product(3, "Cachorro Maine Coon Comida Seca", "Royal Canin", "fk2", 
		...
		productRepository.save(new Product(4, "Cuidado De Peso Comida Seca", "Royal Canin", "fk2",
		...
		productRepository.save(new Product(5, "Digestión Sensible Comida Seca", "Royal Canin", "fk2", 
