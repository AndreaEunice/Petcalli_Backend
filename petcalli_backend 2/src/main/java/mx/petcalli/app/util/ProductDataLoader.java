...
public class ProductDataLoader implements CommandLineRunner {
	...
	/*public void run(String... args) throws Exception {
		...
		productRepository.save(new Product("Mother & Babycat Comida Seca", "Royal Canin", 2, 
		...
		productRepository.save(new Product("Cachorro Maine Coon Comida Seca", "Royal Canin", 2, 
		...
		productRepository.save(new Product("Cuidado De Peso Comida Seca", "Royal Canin", 2,
		...
		productRepository.save(new Product("Digestión Sensible Comida Seca", "Royal Canin", 2, 
